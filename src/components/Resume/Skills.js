    ...
    return (
      <div className="skills">
        ...
        <div className="title">
          <h3>Skills</h3>
          <p>
            I&apos;ve learned quite a few new languages, frameworks, and tools since first
            learning to code in high school. Below, is an attempt at a list of those
            tools I have used for my career and personal projects. I&apos;ve also
            given each skill an honest competency score to highlight which languages and
            frameworks I use most often and am most comfortable with. However, this list
            will surely be constantly updating!
          </p>
        </div>
